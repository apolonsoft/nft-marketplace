...
The production smoke Compose file expects Postgres, Redis, RPC, deployment addresses, and secrets to be supplied through the host environment. `yarn local:up` starts only the local infrastructure services: Postgres, Redis, Kubo, and Anvil.
