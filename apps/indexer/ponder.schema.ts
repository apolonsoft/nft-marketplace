...
const provenance = (t: any) => ({
  chainId: t.integer().notNull(),
  blockNumber: t.bigint().notNull(),
  blockHash: t.text().notNull(),
  transactionHash: t.text().notNull(),
  logIndex: t.integer().notNull(),
  confirmation: t.text().notNull().default('PENDING'),
});
export const collection = onchainTable('collection', (t) => ({
  ...
  royaltyRecipient: t.text().notNull(),
...
export const purchase = onchainTable('purchase', (t) => ({
  ...
  royaltyRecipient: t.text(),
  currency: t.text().notNull(),
  ...provenance(t),
}));
export const royaltyPayment = onchainTable('royalty_payment', (t) => ({
  id: t.text().primaryKey(),
  purchaseId: t.text().notNull(),
...
export const withdrawal = onchainTable('withdrawal', (t) => ({
  id: t.text().primaryKey(),
  payee: t.text().notNull(),
  currency: t.text().notNull(),
  amount: t.bigint().notNull(),
  ...provenance(t),
}));
export const governanceAction = onchainTable('governance_action', (t) => ({
  id: t.text().primaryKey(),
...
export const transactionConfirmation = onchainTable('transaction_confirmation', (t) => ({
  id: t.text().primaryKey(),
  eventType: t.text().notNull(),
  deduplicationKey: t.text().notNull(),
  ...provenance(t),
}));
export const eventOutbox = onchainTable('event_outbox', (t) => ({
  id: t.text().primaryKey(),
  eventType: t.text().notNull(),
  payloadVersion: t.integer().notNull(),
  payload: t.text().notNull(),
  deduplicationKey: t.text().notNull(),
  publishedAt: t.bigint(),
