...
export const domainEventJobSchema = z.object({
  eventId: z.string().min(1), eventType: z.string().min(1), payloadVersion: z.number().int().positive(),
  payload: z.unknown(), deduplicationKey: z.string().min(1), chainId: z.number().int(),
